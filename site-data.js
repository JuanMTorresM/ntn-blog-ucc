window.NTN_SITE_DATA = {
  ...
  "assistant": {
    "quickQuestions": [
      ...
      "Explícame el clúster LEO",
      "¿Cómo funciona el mini-caso?",
      "¿Qué significa Doppler?",
      "¿Quiénes integran el equipo?"
    ],
    "fallback": "No encontré esa información dentro del contenido del proyecto, pero puedo ayudarte con el tema NTN, el mapa, los clústeres, el mini-caso o la metodología.",
    "knowledge": [
      {
        "tags": [
          "ntn",
