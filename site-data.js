window.NTN_SITE_DATA = {
  ...
  "annexes": [
    {
      "code": "A1",
      "title": "Reto ABET SO7 - Comunicaciones II",
      "description": "Documento guía del reto: resultado SO7, evidencias esperadas, flujo de trabajo, mini-caso técnico y reflexión metacognitiva.",
      "url": "assets/docs/reto-abet-so7.pdf",
      "label": "Abrir anexo"
    },
    {
      "code": "A2",
      "title": "Anexo A - Indicaciones de análisis VOSviewer",
      "description": "Guía metodológica usada para la búsqueda, el análisis del mapa, la cadena NTN y el mini-caso de link budget con Doppler.",
      "url": "assets/docs/anexo-a-vosviewer.pdf",
      "label": "Abrir anexo"
    },
    {
      "code": "A3",
      "title": "Anexo B - Presentación en BlogDPC",
      "description": "Criterios del blog académico-digital: declaración obligatoria, navegación, multimedia, chatbot, fuentes y retroalimentación.",
      "url": "assets/docs/anexo-b-blogdpc.pdf",
      "label": "Abrir anexo"
    },
    {
      "code": "A4",
      "title": "Mapa VOSviewer original",
      "description": "Imagen completa del mapa bibliométrico usado como evidencia visual del análisis de términos y clústeres NTN.",
      "url": "assets/images/maps/vosviewer-original.jpg",
      "label": "Ver imagen"
    },
    {
      "code": "A5",
      "title": "Exportación bibliográfica de Scopus",
      "description": "Base de registros académicos revisados para construir la síntesis bibliométrica del proyecto.",
      "url": "assets/data/scopus-export.csv",
      "label": "Abrir datos"
    },
    {
      "code": "A6",
      "title": "Mapa interactivo VOSviewer",
      "description": "Datos del mapa usados por la página para reconstruir nodos, clústeres, ocurrencias, fuerza de enlace y conexiones.",
      "url": "assets/data/vosviewer-map.json",
      "label": "Abrir datos"
    }
  ]
};
